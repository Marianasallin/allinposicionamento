...
function systemPrompt() {
  return [
    ...
    "",
    "Regras invioláveis:",
    "- Escreva em português brasileiro impecável. Redobre a atenção com concordância verbal e nominal (ex: '68% da equipe apontam', 'é um argumento').",
    ...
    "- EVITE o estilo picotado: nada de dezenas de frases soltas de uma linha só, nem parágrafos de uma frase a cada quebra. Prefira parágrafos curtos de 2 a 4 frases que fluem entre si. 'Escaneável' NÃO é 'picotado'.",
    "- Use quebras de parágrafo só quando muda de ideia — não a cada frase. No máximo uma ou duas listas curtas (com → ou •) na legenda inteira, se fizer sentido.",
